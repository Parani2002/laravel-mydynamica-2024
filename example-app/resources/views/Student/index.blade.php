                ...
                <div class="col-xl-3 col-md-6">
                    <div class="card bg-primary text-white mb-4">
                        <div style="display: flex; justify-content: center;padding:5px">
                            ...
                            <div class="card-body"><h3>Students</h3></div>
                            <div class="card-body"><h3>{{$students_count}}</h3></div>
                        </div>
                ...
                <div class="col-xl-3 col-md-6">
                    <div class="card bg-warning text-white mb-4">
                        <div style="display: flex;justify-content: center;padding:5px;">
                            ...
                            <div class="card-body"><h3>Grades</h3></div>
                            <div class="card-body"><h3>{{$grades_count}}</h3></div>
                        </div>
                        <div class="card-footer d-flex align-items-center justify-content-between">
                ...
                <div class="col-xl-3 col-md-6">
                    <div class="card bg-success text-white mb-4">
                        <div style="display: flex;justify-content: center;padding:5px;">
                            ...
                            <div class="card-body"><h3>Subjects</h3></div>
                            <div class="card-body"><h3>{{$subjects_count}}</h3></div>
                        </div>
                        <div class="card-footer d-flex align-items-center justify-content-between">
